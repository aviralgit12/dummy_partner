...
<body class="bg-gray-100">
    ...
    <script>
        // Configuration
        const MAIN_WEBSITE_URL = 'https://mainwebsite.com';
 ...
 //handle create api
            if (isCreateMode) {
                ...
                const userIndex = dummyUsers.findIndex(user => user.id === parseInt(userId));
        ...
        function redirectToShop(uuid) {
            window.location.href = `${MAIN_WEBSITE_URL}?uuid=${uuid}`;
        }
